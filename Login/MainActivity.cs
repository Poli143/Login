...
namespace Login
{
    ...
    public class MainActivity : Activity, IFacebookCallback, GraphRequest.IGraphJSONObjectCallback
    {
        ...
        private Button mBtnKontynuacja;
        ...
        private void mBtnKontynuacja_Click(object sender, EventArgs e)
        {
            if ( AccessToken.CurrentAccessToken != null )
            {
                StartActivity(typeof(przegladKategori));

            }
            else
            {
                string result = "Zaloguj się";
        ...
        void mProfileTracker_mOnProfileChanged(object sender, OnProfileChangedEventArgs e)
        {
            if (e.mProfile != null)
            {
                ...
                try
                {
                    mTxtFirstName.Visibility = ViewStates.Visible;
                    mTxtLastName.Visibility = ViewStates.Visible;
            ...
            {
                mTxtFirstName.Visibility = ViewStates.Invisible;
                mTxtLastName.Visibility = ViewStates.Invisible;
